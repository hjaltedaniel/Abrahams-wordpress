...
get_header();
//Her gives data fra tabellen, forskellige variabler.
$date = get_field('dato');
...
?>
    ...
    <div class="container">
        ...
        <?php
        //Betingelse der viser indlægget, hvis det findes - og datoen ikke allerede har fundet sted.
        if ( have_posts() && date(Ymd) <= $date ) : while ( have_posts() ) : the_post(); ?>
            ...
            <div class="card-deck deck mb-5">
                <?php 
                //Her vises listen over kategorier, som også findes på kategorisiderne.
